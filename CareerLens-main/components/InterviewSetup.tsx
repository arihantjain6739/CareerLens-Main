            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-2">
                        <h1 className="text-2xl font-bold text-white">Get Ready for your Interview</h1>
                        <span className="text-sm font-semibold text-white">{progress}% Complete</span>
                    </div>
                    <p className="text-sm text-neutral-400 mb-4">Step 4 of 4: Interview Setup</p>
                                    ...
                                    <div className="flex items-end gap-1 h-6">
                                        {[0, 1, 2, 3, 4].map(i => {
                                            ...
                                            return (
                                                <div
                                                    key={i}
                                                    style={{ width: 4, height: `${height}px`, background: '#fff', opacity: opacity > 0.1 ? opacity : 0.15, borderRadius: 2 }}
                                                />
                                            );
                                        })}
                                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-lg focus:outline-none focus:border-neutral-500 text-white transition-colors duration-200"
                                    >
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-neutral-900 rounded-xl p-6 sticky top-8 border border-neutral-800">
                            <div className="flex items-center space-x-2 mb-6">
                                ...
                                <h2 className="text-lg font-semibold text-white">How the AI evaluates you</h2>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-white mb-1">Confidence Analysis</h3>
                                        <p className="text-sm text-neutral-400">AI tracks eye contact consistency and posture stability.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-white mb-1">Answer Relevance</h3>
                                        <p className="text-sm text-neutral-400">Measures how well you stay on topic and the depth of your knowledge.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-white mb-1">Speaking Skills</h3>
                                        <p className="text-sm text-neutral-400">Analyzes clarity, pace, tone, and use of filler words (um, uh, like).</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 pt-6 border-t border-neutral-800">
                                <label className="flex items-start space-x-3 cursor-pointer">
                                    <input
                                        ...
                                        className="mt-1 h-4 w-4 bg-neutral-800 border-neutral-600 rounded focus:ring-white accent-white"
                                    />
                            ...
                            <button
                                ...
                                className="w-full mt-6 bg-white hover:bg-neutral-200 disabled:bg-neutral-700 disabled:text-neutral-500 disabled:cursor-not-allowed text-black font-semibold py-3 px-6 rounded-xl flex items-center justify-center space-x-2 transition-all duration-200"
                            >
